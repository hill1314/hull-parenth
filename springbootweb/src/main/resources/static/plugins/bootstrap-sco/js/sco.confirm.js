...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			...
			'			<button type="button" class="close" data-dismiss="modal" aria-hidden="true" id="uiBoxCloseBtn">&times;</button>'+
			'			<h4 class="modal-title">&nbsp;</h4>'+
			'		</div>'+
			'		<div class="modal-body" id="confirmMsg"></div>'+
			'		<div class="modal-footer">'+
			'			<a href="#" class="btn btn-danger btn-sm" data-action="1" id="uiBoxYeapBtn">Submit</a> '+
			'			<a class="btn btn-primary btn-sm cancel" href="#" data-dismiss="modal" id="uiBoxCancellBtn">Cancel</a>'+
			'		</div>'+
			'   </div>'+
			'  </div>'+
			'</div>';
